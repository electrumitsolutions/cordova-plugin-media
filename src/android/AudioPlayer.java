...
//    private static int MEDIA_ERR_NONE_SUPPORTED = 4;
    ...
    private String generateTempFile() {
      ...
      if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
          tempFileName = Environment.getExternalCacheDir().getAbsolutePath() + "/tmprecording-" + System.currentTimeMillis() + ".3gp";
      } else {
    ...
    public void moveFile(String file) {
        ...
        if (!file.startsWith("/")) {
            if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
                file = Environment.getExternalCacheDir().getAbsolutePath() + File.separator + file;
            } else {
